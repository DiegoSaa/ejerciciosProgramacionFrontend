...
const Filtro = (props) => {
  ...
  return (
    <Dropdown className="btn btn-primary btn-sm" onSelect={toggle}>
      <Dropdown.Toggle className="flecha btn btn-secundary btn-sm">
      ...
      <Dropdown.Menu>
        ...
        <Dropdown.Item id="0" key="0" eventKey="0" active={fechaNuevo}>
          {" "}
          Nuevas - Antiguas{" "}
        </Dropdown.Item>
        <Dropdown.Item id="1" key="1" eventKey="1" active={fechaAntiguo}>
          {" "}
          Antiguas - Nuevas{" "}
        </Dropdown.Item>
        ...
        <Dropdown.Item id="2" key="2" eventKey="2" active={calMenor}>
          {" "}
          0 - 10 puntos{" "}
        </Dropdown.Item>
        <Dropdown.Item id="3" key="3" eventKey="3" active={calMayor}>
          {" "}
          10 - 0 puntos{" "}
        </Dropdown.Item>
      </Dropdown.Menu>
